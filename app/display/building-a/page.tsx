...
export default function BuildingADisplay() {
  ...
  const buildingCourts = courts.filter(c => c.building === 'building_a');
  const buildingQueue = queueEntries.filter(e => e.building === 'building_a' && e.status === 'waiting');
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6 flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-6xl font-bold">Building A</h1>
        </div>
      ...
      {/* Courts Grid */}
      <div className="bg-black/40 backdrop-blur-md rounded-2xl p-3 mb-2 border border-white/20 shadow-2xl flex-shrink-0">

...
export default function BuildingCDisplay() {
  ...
  const buildingCourts = courts.filter(c => c.building === 'building_c');
  const buildingQueue = queueEntries.filter(e => e.building === 'building_c' && e.status === 'waiting');
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6 flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-6xl font-bold">Building C</h1>
        </div>
